import pytest
from libgen.client import LibgenClientAsync
...
async def test_search_success():
    ...
    async with LibgenClientAsync() as client:
        results = await client.search("python data science")
...
async def test_search_no_results():
    ...
    async with LibgenClientAsync() as client:
        with pytest.raises(LibgenSearchError) as excinfo:
            await client.search("nonexistentbookxyz123abc")
